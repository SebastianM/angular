...
import {MessageBus, MessageBusInterface} from 'angular2/src/web_workers/shared/message_bus';
...
function _injectorBindings(appComponentType, bus: MessageBus,
